...
export const pyroscopeDatasourceSchema = z.object({
  kind: z.literal('PyroscopeDatasource'),
  spec: z
    .object({
...
export function usePyroscopeDatasourceValidation(): void {
  ...
  useEffect(() => setSchema.current?.(pyroscopeDatasourceSchema), []);
}
