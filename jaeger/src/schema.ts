...
export const jaegerDatasourceSchema = z.object({
  kind: z.literal('JaegerDatasource'),
  spec: z
    .object({
...
export function useJaegerDatasourceValidation(): void {
  ...
  useEffect(() => setSchema.current?.(jaegerDatasourceSchema), []);
}
