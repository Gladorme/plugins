...
export const tempoDatasourceSchema = z.object({
  kind: z.literal('TempoDatasource'),
  spec: z
    .object({
...
export function useTempoDatasourceValidation(): void {
  ...
  useEffect(() => setSchema.current?.(tempoDatasourceSchema), []);
}
