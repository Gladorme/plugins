...
export function TempoTraceQueryEditor(props: TraceQueryEditorProps): ReactElement {
  ...
  const datasourceSelectLabelID = `tempo-datasource-label-${useId()}`; // for panels with multiple queries, this component is rendered multiple times on the same page
