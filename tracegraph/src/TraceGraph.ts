...
import { createInitialTraceGraphOptions } from './trace-graph-options';
...
export const TraceGraph: PanelPlugin<TraceGraphOptions, TraceGraphPanelProps> = {
  PanelComponent: TraceGraphPanel,
  supportedQueryTypes: ['TraceQuery'],
  createInitialOptions: createInitialTraceGraphOptions,
};
