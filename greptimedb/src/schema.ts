...
export const greptimeDBDatasourceSchema = z.object({
  kind: z.literal('GreptimeDBDatasource'),
  spec: z
    .object({
...
export function useGreptimeDBDatasourceValidation(): void {
  ...
  useEffect(() => setSchema.current?.(greptimeDBDatasourceSchema), []);
}
