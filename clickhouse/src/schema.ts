...
export const clickHouseDatasourceSchema = z.object({
  kind: z.literal('ClickHouseDatasource'),
  spec: z
    .object({
...
export function useClickHouseDatasourceValidation(): void {
  ...
  useEffect(() => setSchema.current?.(clickHouseDatasourceSchema), []);
}
