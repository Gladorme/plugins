...
export const traceTableSchema = z.object({
  ...
  spec: z
    .object({
      visual: z
        ...
        .strict()
        .optional(),
      links: z.object({ trace: z.string().optional() }).strict().optional(),
...
export function useTraceTableValidation(): void {
  ...
  useEffect(() => setSchema.current?.(traceTableSchema), []);
}
