...
export const openSearchDatasourceSchema = z.object({
  kind: z.literal('OpenSearchDatasource'),
  spec: z
    .object({
...
export function useOpenSearchDatasourceValidation(): void {
  ...
  useEffect(() => setSchema.current?.(openSearchDatasourceSchema), []);
}
